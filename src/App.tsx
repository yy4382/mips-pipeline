...
import { TomasoluComp } from "./components/tomasolu/tomasolu";
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/tomasolu" element={<TomasoluApp />}></Route>
      </Routes>
...
function TomasoluApp() {
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-900 py-8">
      <header className="mb-8">
        <div className="container mx-auto px-4">
          <h1 className="text-3xl font-bold text-center text-slate-900 dark:text-slate-100">
            Tomasolu Algorithm Simulator
          </h1>
          <p className="text-center text-slate-500 dark:text-slate-400 mt-2">
            Visual representation of a Tomasolu pipeline with hazard detection
            <br />A course project.
          </p>
        </div>
      </header>
