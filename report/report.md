...
运行前设置好内存
![alt text](no-raw-pre-run-set-mem.png)

直接运行到结束（Run to End 按钮）

流水线时空图

![流水线时空图](no-raw-chart.png)

寄存器和内存的值

![寄存器和内存的值](no-raw-mem-reg.png)
...
![alt text](CleanShot_2025-04-30_11.22.16.png)

![alt text](CleanShot_2025-04-30_11.22.27.png)

![alt text](CleanShot_2025-04-30_11.22.40.png)
...
![alt text](CleanShot_2025-04-30_11.28.03.png)

第5周期，虽然还未写入，但是数据已经可用，所以定向发生，不再停顿。

![alt text](CleanShot_2025-04-30_11.28.58.png)

![alt text](CleanShot_2025-04-30_11.29.06.png)
...
![alt text](CleanShot_2025-04-30_11.31.35.png)
...
![alt text](CleanShot_2025-04-30_11.57.30.png)
...
统计信息：
![alt text](CleanShot_2025-04-30_11.57.56.png)
